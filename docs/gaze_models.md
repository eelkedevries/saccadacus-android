...
| 2 | **WebEyeTrack / BlazeGaze** | RedForestAI (Vanderbilt) | eye RGB + head pose → PoG | ~2.0–2.3 cm | 2025 | 2025 | TF/TFJS, 0.67 MB | **MIT** | Closest to our *full* stack (MediaPipe + patch + head pose + few-shot); tiny. Newest/least-tested. |
...
| 9 | **Open Gaze** (replication) | open repl. (arXiv 2308.13495) | eye crops + landmarks → PoG | ~1.9 cm | 2023 | ~2023 | repo weights | research (repo) | Open clone of Google's 0.46 cm approach; worse than the original. |
